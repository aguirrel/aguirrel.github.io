...
#define MAX_LONG 1024 /* DS29052001 */ 
...
{ 
{VER22, TYPE_PRICE_VENTA,36,{{1,27},{2,4},{3,4},{4,19},{5,2},{6,12},{7,12},
                           {8,4},{9,1},{10,37},{11,4},{12,3},{13,2},{14,3},
                           {15,3},{16,5},{17,2},{18,8},{22,2},{23,3},{24,1},
                           {20,6},{25,4},{26,3},{27,5},{28,4},{21,2},
			   {29,9},{30,76},{31,1},{32,12},{33,9},{34,300},
                           {35,15},{36,1},{37,3}}}, /* Pinpad2. Agregado {31,1} */

 {VER22, TYPE_PRICE_VENTA_RTA,19,{{1,27},{2,3},{3,5},{4,4},{5,4},{6,2},{7,19},
                           {8,2},{9,6},{10,6},{11,15},{12,25},{15,2},{16,12},
				{13,18},{14,25},{17,28},{18,40},{19,300}}}, /* Modificacion PINPAD ( {13,20} -> {13,18} ) */
